  ...
  return (
    <section className={cn(className) + ' w-full'}>
      <div className="container px-4 md:px-6">
        ...
        <div className="relative mt-12 grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
          <div className="rounded-lg border bg-white p-4 dark:border-gray-700 dark:bg-gray-950">
