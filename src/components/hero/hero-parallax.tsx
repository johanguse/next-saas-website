...
export const HeroParallax = ({
  ...
  return (
    <div
      ...
      className={
        className +
        ' relative flex h-[230vh]  flex-col self-auto overflow-hidden pt-20 antialiased [perspective:1000px] [transform-style:preserve-3d]'
      }
    >
      <Header />
      <motion.div
    ...
    <div className="relative left-0 top-0 z-50 mx-auto w-full max-w-7xl  px-4 py-10 md:py-20">
      ...
      <BlockTitle.Wrapper>
        ...
        <BlockTitle.Description>
          Empower Your Next Project with Next.js 14, Prisma, PostgreSQL, Auth.js
          v5, Resend, React Email, Shadcn/ui, Stripe Integration and a lot of
        ...
        <p className="my-6 flex align-middle md:mb-6 md:mt-8">
          <svg
            className="mr-2 size-5 animate-pulse fill-green-500 text-green-600"
            viewBox="0 0 161 154"
            fill="none"
          ...
          <span className="mr-2 text-green-500">35%</span> off for the first 50
          customers (43 Left)
        </p>
      </BlockTitle.Wrapper>
    </div>
